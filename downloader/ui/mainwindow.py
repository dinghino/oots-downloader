...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pb_first.setShortcut(_translate("MainWindow", "F", None))
        self.pb_prev.setText(_translate("MainWindow", "< &Prev", None))
        self.pb_prev.setShortcut(_translate("MainWindow", "P", None))
        self.pb_next.setText(_translate("MainWindow", "&Next >", None))
        self.pb_next.setShortcut(_translate("MainWindow", "N", None))
        self.pb_last.setText(_translate("MainWindow", "&Last", None))
        self.pb_last.setShortcut(_translate("MainWindow", "L", None))
