...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(_fromUtf8(":/fA/resources/search-plus.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/fA/resources/search-minus.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/fA/resources/arrows-alt.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_full_screen.setIcon(icon7)
        ...
        self.toolBar_main.addSeparator()
        self.toolBar_main.addAction(self.action_zoom_in)
        self.toolBar_main.addAction(self.action_zoom_out)
        self.toolBar_main.addSeparator()
        self.toolBar_main.addAction(self.action_full_screen)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_zoom_in.setText(_translate("MainWindow", "&Zoom in", None))
        self.action_zoom_in.setShortcut(_translate("MainWindow", "Ctrl++", None))
        self.action_zoom_out.setText(_translate("MainWindow", "&Zoom out", None))
        self.action_zoom_out.setShortcut(_translate("MainWindow", "Ctrl+-", None))
        self.action_full_screen.setText(_translate("MainWindow", "&Full screen", None))
